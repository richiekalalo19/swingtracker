// Modified Swing Tracker Code with Embedded HTML for Web Server Functionality
#include <Wire.h>
...
// Embedded HTML page as a raw string
...
<body>
  ...
  <script>
    ...
    eventSource.addEventListener('new_readings', function(event) {
      ...
      document.getElementById('accelZ_filtere d').textContent = data.accelZ_filtered.toFixed(2);
    });
  </script>
</body>
</html>
